...
// SeedOption defines the structure of options as they appear in the initial mock data.
// This is used before conversion to JSONB for database storage.
...
// SeedQuestion defines the structure of questions as they appear in the initial mock data.
// This is used before conversion to the GORM Question model for database storage.
type SeedQuestion struct {
	ID         string       `json:"id"`         // e.g., "net-e-q1"
	Topic      string       `json:"topic"`      // e.g., "Network"
	Difficulty string       `json:"difficulty"` // e.g., "easy"
	Text       string       `json:"text"`
	Options    []SeedOption `json:"options"`
}

// questionsToSeed holds the initial set of quiz questions in their raw format.
// This data will be processed by the seeder to populate the database.
