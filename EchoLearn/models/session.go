...
type GameSession struct {
	...
	CurrentQuestionID string    `gorm:"type:varchar(36)" json:"current_question_id,omitempty"` // ID of the current question
	CurrentQuestion   int       `json:"current_question_index"`                                // Index for modes like 5-topic (can be used alongside ID or for specific scenarios)
